  ...
  return (
    <section className="relative content-center items-center box-border caret-transparent gap-x-11 flex flex-col shrink-0 h-min justify-center gap-y-11 w-full overflow-hidden px-[18px] py-20 md:px-10 md:py-[100px]">
      ...
      <div className="[mask-image:radial-gradient(50%_109%,rgb(0,0,0)_0%,rgba(0,0,0,0.965)_0%,rgba(0,0,0,0)_96%)] absolute box-border caret-transparent blur-lg shrink-0 h-[1790px] left-[calc(50%_-_571px)] opacity-90 pointer-events-none top-[-728px] w-[1142px] z-[2] overflow-hidden">
        <div className="absolute bg-[radial-gradient(50%_50%,rgb(138,165,255)_0%,rgba(171,171,171,0)_100%)] box-border caret-transparent shrink-0 h-[2072px] left-[calc(50%_-_20px)] opacity-[0.135] top-[-352px] origin-[100%_0%] w-10 z-[1] overflow-hidden scale-[0.65] md:opacity-[0.26568] md:scale-[0.9888]"></div>
        <div className="absolute bg-[radial-gradient(50%_50%,rgb(138,165,255)_0%,rgba(171,171,171,0)_100%)] bottom-[-920px] box-border caret-transparent shrink-0 left-[calc(50%_-_17.5px)] opacity-[0.172592] top-[-352px] rotate-[24.999950067821864deg] origin-[100%_0%] w-[35px] z-[1] overflow-hidden scale-[0.6643501952976307] md:opacity-[0.240352] md:rotate-[25.000015321783728deg] md:scale-[0.8760998309507884]"></div>
        <div className="absolute bg-[radial-gradient(50%_50%,rgb(138,165,255)_0%,rgba(171,171,171,0)_100%)] bottom-[-920px] box-border caret-transparent shrink-0 left-[calc(50%_-_17.5px)] opacity-[0.31578] top-[-352px] rotate-[10.999967891350822deg] origin-[100%_0%] w-[35px] z-[1] overflow-hidden scale-[0.6877997449934101] md:opacity-[0.285] md:rotate-[11.000007676071172deg] md:scale-[0.6500003538768268]"></div>
        ...
        <div className="absolute bg-[radial-gradient(50%_50%,rgb(138,165,255)_0%,rgba(171,171,171,0)_100%)] bottom-[-920px] box-border caret-transparent shrink-0 left-[calc(50%_-_25px)] opacity-[0.26445] top-[-352px] rotate-[-18.000005241796863deg] origin-[100%_0%] w-[50px] z-[1] overflow-hidden scale-[0.9170496295250329] md:opacity-[0.1671] md:rotate-[-18.00001106037244deg] md:scale-[0.6899001583106066]"></div>
        <div className="absolute bg-[radial-gradient(50%_50%,rgb(138,165,255)_0%,rgba(171,171,171,0)_100%)] box-border caret-transparent shrink-0 h-[2704px] opacity-[0.18555] top-[-342px] rotate-[-17.999996499001295deg] origin-[100%_0%] w-[50px] z-[1] overflow-hidden scale-[0.7329501183334374] right-[446px] md:opacity-[0.1671] md:rotate-[-18.00001106037244deg] md:scale-[0.6899001583106066]"></div>
        <div className="absolute bg-[radial-gradient(50%_50%,rgb(138,165,255)_0%,rgba(171,171,171,0)_100%)] bottom-[-910px] box-border caret-transparent shrink-0 left-[calc(69.2645%_-_25px)] opacity-[0.18555] top-[-362px] rotate-[-17.999996499001295deg] origin-[100%_0%] w-[50px] z-[1] overflow-hidden scale-[0.7329501183334374] md:opacity-[0.1671] md:rotate-[-18.00001106037244deg] md:scale-[0.6899001583106066]"></div>
        <div className="absolute bg-[radial-gradient(50%_50%,rgb(138,165,255)_0%,rgba(171,171,171,0)_100%)] bottom-[-920px] box-border caret-transparent shrink-0 left-[calc(50%_-_10px)] opacity-[0.19275] top-[-352px] rotate-[-4.9999984529419725deg] origin-[100%_0%] w-5 z-[1] overflow-hidden scale-[0.7497500234304765] md:opacity-30 md:rotate-[-4.999996052434918deg]"></div>
        <div className="absolute bg-[radial-gradient(50%_50%,rgb(138,165,255)_0%,rgba(171,171,171,0)_100%)] bottom-[-910px] box-border caret-transparent shrink-0 left-[calc(69.2645%_-_10px)] opacity-[0.19275] top-[-362px] rotate-[-4.9999984529419725deg] origin-[100%_0%] w-5 z-[1] overflow-hidden scale-[0.7497500234304765] md:opacity-30 md:rotate-[-4.999996052434918deg]"></div>
        <div className="absolute bg-[radial-gradient(50%_50%,rgb(138,165,255)_0%,rgba(171,171,171,0)_100%)] box-border caret-transparent shrink-0 h-[2704px] opacity-[0.642] top-[-352px] rotate-[-5.0000010070524565deg] origin-[100%_0%] z-[1] overflow-hidden scale-[0.7493996932306884] left-[881px] right-[241px] md:opacity-100 md:rotate-[-4.999996052434918deg]"></div>
